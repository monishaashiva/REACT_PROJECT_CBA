              ...
              <div className="relative">
                ...
                <div className="mt-6 flex space-x-3">
                  {!isScanning && !scanResult ? (
                    <Button onClick={startScanning} className="flex-1">Start Scanning</Button>
                  ) : isScanning ? (
                    <Button variant="danger" onClick={stopScanning} className="flex-1">Stop Scanning</Button>
                  ) : (
                    <>
                      <Button onClick={processPayment} className="flex-1">Process Payment</Button>
                      <Button variant="outline" onClick={rejectPayment} className="flex-1">Reject</Button>
                    </>
                  )}
                </div>
              </div>
